        ...
        <div className="container">
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    Textutils gives you a way to analyze your text quickly and efficiently. Be it word count, character count or changing the case of characters, textutils has it all!
                    </div>
                    </div>
                </div>
                <div className="accordion-item">
